...
* Hijacked Chrome / Edge extensions (35 known IDs from the December-2024 supply-chain breach)  
...
1. **Scan browser extension folders** (`Extensions/` under Chrome & Edge)  
   *Compares every folder ID to the public list of 35 compromised IDs.*  
2. **Scan temp / cache directories** (`%TEMP%`, `%APPDATA%`, `/tmp`, `~/.cache`)  
